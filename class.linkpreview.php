...
$linkPreview = new LinkPreview($_GET['url']);
?>
<html>
    <head>
        ...
        <table id="at_preview">
            <tbody>
                <tr>
                    <td width="100">
                        <img width="100" 
                             data-src = "<?php $linkPreview->getImage(1); ?>" 
                             src="<?php $linkPreview->getImage();  ?>">
                    </td>
                    <td style="vertical-align: top;">
                        <span><strong><?php $linkPreview->getTitle();  ?></strong></span>
                        <span style="display: block;margin-top: 8px;"><?php $linkPreview->getDescription();  ?></span>
                    </td>
                </tr>
                <tr class="preview_footer">
                    <td colspan="2">
                        <span>Source:
                            <a href="<?php echo $linkPreview->url; ?>"><?php echo preg_replace('#^https?://#', '', $linkPreview->url);  ?>
                            </a>
                        </span>
                    </td>
                </tr>
